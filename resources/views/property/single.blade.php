            ...
            <div class="flex justify-between">
                <div class="w-8/12">
                    ...
                    <h3 class="text-lg mt-2">{{ __('Price') }}: <span class="text-red-800">
                        ...
                        {{-- {{ number_format($property->price) }} {{ __('HKD') }}</span> --}}
                        ...
                        <li>
                            <a class="flex flex-col justify-center items-center mx-2 border-2 border-gray-200 p-3 hover:border-red-400 duration-200"
                               href="#">
                                ...
                                <span class="text-md block">{{ __('Print') }}</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex flex-col justify-center items-center mx-2 border-2 border-gray-200 p-3 hover:border-red-400 duration-200"
                               href="#">
                                ...
                                <span class="text-md block">{{ __('Save') }}</span></a>
                        </li>
                        <li>
                            <a class="flex flex-col justify-center items-center mx-2 border-2 border-gray-200 p-3 hover:border-red-400 duration-200"
                               href="#">
                                <i class="fa fa-share-alt mb-2"></i>
                                <span class="text-md block">{{ __('Share') }}</span></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="flex justify-between">
            ...
            <div class="w-9/12">
                ...
                <div class="bg-white p-8 mt-10 shadow-sm" id="description">
                    <h2 class="font-bold mb-5 text-2xl"> {{ __('FACILITIES') }} &amp; {{ __('LOCATION') }}</h2>
                        @if(request()->is('*tr*'))
            ...
            <div class="w-3/12 ml-6">
                <div class="border-2 border-red-800 px-5 py-3 text-center font-light text-base">
                    <p>{{ __('Subscribe to BOCHK Smart Realtor for blogs/news/videos') }}</p>
                </div>
                {{-- Form --}}
                <div class="px-4 py-5 text-left bg-gray-300 my-5">
                    <h1 class="text-2xl font-normal leading-none mb-5 langBN">{{ __('Sign this property') }}</h1>
                     <!-- Link Button -->
                    <div class="mt-5">
                        <button onclick="location.href='http://192.168.30.91:3000/'" type="button" class="w-full border-2 uppercase text-center py-3 font-semibold border-red-800 hover:bg-transparent hover:text-red-800 duration-200  text-white bg-red-800 rounded-none"><i class="fa fa-handshake-o mr-2"></i>{{__('Sign')}}</button>
                    </div>
                    
                    <form action="{{ route('enquireSign',$property->id) }}" method="POST" enctype="multipart/form-data">
                        <!-- @csrf -->

                        <div class="">
                            <label class="inputLabel" for="name">{{ __('Name') }} 
                        ...
                        <div class="mt-5">
                            <label class="inputLabel" for="phone">{{ __('Phone') }}
                                <!-- <span class="text-red-800 font-serif">*</span> -->
                            </label>
                        ...
                        <div class="mt-5">
                            <label class="inputLabel" for="email">{{ __('Email') }} 
                                <!-- <span class="text-red-800 font-serif">*</span> -->
                            </label>
                        ...
                        <div class="mt-5">
                            <label class="inputLabel" for="message">{{ __('Message') }} 
                                <!-- <span class="text-red-800 font-serif">*</span> -->
                            </label>
                        ...
                        <div class="mt-5">
                            <button onclick="location.href='https://t.me/King_Imp_joffery'" type="button" class="w-full border-2 uppercase text-center py-3 font-semibold border-red-800 hover:bg-transparent hover:text-red-800 duration-200  text-white bg-red-800 rounded-none"><i class="fa fa-commenting mr-2"></i>{{__('Enquiry')}}</button>
                        </div>
