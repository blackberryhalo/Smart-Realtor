    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('properties.create') }}"
                class="px-4 py-2 hover:text-white text-white rounded-md text-base bg-gradient-to-r from-red-600 to-blue-500 hover:from-pink-500 hover:to-yellow-500">Add New Property</a>
        </div>
    </x-slot>
                    ...
                    <table class="w-full table-auto mb-4">
                        ...
                        <tbody>
                            @forelse ($properties as $item)
                                <tr class="bg-red-300 text-black hover:bg-red-500 hover:text-white duration-50">
