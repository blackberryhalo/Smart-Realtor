    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('properties.index') }}"
                class="px-4 py-2 hover:text-white text-white rounded-md text-base bg-gradient-to-r from-red-600 to-blue-500 hover:from-pink-500 hover:to-yellow-500">Back</a>
        </div>
    </x-slot>
                ...
                <div class="m-4">
                    <form action="{{route('properties.store')}}" method="post" class="p-6 bg-white border-b border-gray-200" enctype="multipart/form-data">
                        ...
                        <div class="flex -mx-4 mb-6">
                            ...
                            <div class="flex-1 px-4">
                                <label class="civanoglu-label" for="overview_tr">Overview - EN <span class="required-text">*</span></label>
                        ...
                        <div class="flex -mx-4 mb-6">
                            ...
                            <div class="flex-1 px-4">
                                <label class="civanoglu-label" for="why_buy_tr">Why buy - EN <span class="required-text">*</span></label>
                        ...
                        <div class="flex -mx-4 mb-6">
                            ...
                            <div class="flex-1 px-4">
                                <label class="civanoglu-label" for="description_tr">Description - EN <span class="required-text">*</span></label>
