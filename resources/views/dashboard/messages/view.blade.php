<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('message.index') }}" class="px-4 py-2 hover:text-white text-white rounded-md text-base bg-gradient-to-r from-red-600 to-blue-500 hover:from-pink-500 hover:to-yellow-500">Back</a>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-5 mx-auto">
                    ...
                    <div class="flex">
                        ...
                        <button type="button" class="mx-1 hover:bg-black hover:text-white duration-200 leading-none bg-purple-700 text-white px-3 py-2 text-sm rounded-md"><a href="https://wa.me/26{{$enquiry->phone}}">Reply on WhatsApp</a></button>
