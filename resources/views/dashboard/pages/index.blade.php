<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('pages.create') }}" class="px-4 py-2 hover:text-white text-white rounded-md text-base bg-gradient-to-r from-red-600 to-blue-500 hover:from-pink-500 hover:to-yellow-500">Add New Page</a>
        </div>
    </x-slot>
